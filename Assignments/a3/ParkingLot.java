...
public class ParkingLot {
	...
	public ParkingLot(int capacity) {
		...
		if (capacity < 0) {
			...
			throw new IllegalArgumentException("Parking Lot capacity must have a positive value!");
	...
	public Spot remove(int i) {
        ...
        if (i < 0 || i >= occupancy.size()) {
            throw new IndexOutOfBoundsException("Position Index out of Range!");
        } 

        /* Else, get spot from occupancy */
        else {
        	s = occupancy.get(i);
            occupancy.remove(i);
        }
	 ...
	 * 
	 * @param i is the index of the spot to be returned
